...
/* package Haskell-Fractals-0.1.0.0 */
#define VERSION_Haskell_Fractals "0.1.0.0"
#define MIN_VERSION_Haskell_Fractals(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Haskell-Fractals-0.1.0.0"

#define CURRENT_PACKAGE_KEY "Haskell-Fractals-0.1.0.0"
